...
signupForm.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    signupForm.reset();
    setTimeout(() => showThankYouPage(data.user), 1000);
  } catch (err) {
...
function showThankYouPage(user) {
  document.body.innerHTML = `
    <div class="thankyou-page">
      <div class="thankyou-card">
        ...
        <p>
          Your login was successful. This project demonstrates a secure full stack
          authentication system built with Node.js, Express, MongoDB, JWT, HTML, CSS, and JavaScript.
        </p>
        <div class="thankyou-buttons">
          <a href="/" class="gold-btn">Back to Login</a>
          <a href="https://vajeedshaikh82-ux.github.io/vajeed-portfolio/" target="_blank" class="outline-btn">View Portfolio</a>
        </div>
      </div>
    </div>
  `;
